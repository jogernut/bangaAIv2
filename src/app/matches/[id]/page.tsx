    ...
    <MainLayout>
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6">
        ...
        <div className="flex items-center space-x-2 mb-4">
          <span className="text-2xl">{getCountryFlag(match.country)}</span>
          <span className="text-gray-300">{match.country}</span>
          <span className="text-gray-500">•</span>
          <span className="text-gray-300">{match.league}</span>
        </div>
