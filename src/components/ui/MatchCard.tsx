...
export default function MatchCard({ 
  ...
  return (
    <Link
      href={detailsUrl}
      className={cn(
        "block bg-gray-800 border border-gray-700 rounded-lg p-4 hover:border-gray-600 hover:bg-gray-750 transition-all duration-200 transform hover:scale-[1.01] hover:shadow-lg group cursor-pointer",
        className
      )}
    >
      {/* CSS Grid Layout: Time | Teams | Predictions | Arrow */}
      <div className="grid grid-cols-[60px_1fr_320px_20px] gap-6 items-center">
        {/* Time */}
