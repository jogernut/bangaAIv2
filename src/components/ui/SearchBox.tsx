    ...
    <div className={`relative ${className}`}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 rounded-lg focus:outline-none focus:border-blue-500 transition-colors bg-white text-gray-900 placeholder-gray-500 border border-gray-300 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400 dark:border-gray-700"
        />
          ...
          <div className="max-h-80 overflow-hidden">
            {filteredResults.map((result, index) => (
              <button
                ...
                className="w-full px-4 py-3 text-left transition-all duration-150 border-b last:border-b-0 group focus:outline-none hover:bg-gray-100 focus:bg-gray-100 border-gray-200 dark:hover:bg-gray-700 dark:focus:bg-gray-700 dark:border-gray-700/50"
              >
                <div className="flex items-start space-x-3">
                  <span className="text-lg mt-0.5 flex-shrink-0">{getTypeIcon(result.type)}</span>
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <div className="flex items-center space-x-2 mb-1">
                      <span className="font-medium transition-colors truncate text-gray-900 group-hover:text-blue-700 dark:text-white dark:group-hover:text-blue-300">
                        {result.name}
                      </span>
                      <span className="text-xs px-2 py-0.5 rounded-full flex-shrink-0 transition-colors text-gray-600 bg-gray-100 group-hover:bg-gray-200 dark:text-gray-300 dark:bg-gray-700/80 dark:group-hover:bg-gray-600/80">
